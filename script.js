...
const benefits=['7 змістовних занять','Лайфхаки для логічного оповідання','Розбір реального твору учениці','Шаблон оповідання зі словничком','Пробні тести та визначення готовності','Допомога з реєстрацією на екзамен','Підтримка вчителя','Аналіз готовності до частини Mówienie'];
